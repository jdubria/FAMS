        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Manage Class Schedule</a>
                </div>
          ...
          <div class="row">
            <div class="col-sm-7">
              <div class="table-responsive">
                <br>
                  <div class="pull-right">
                      <a href="#assign_subject" class="btn btn-sm btn-outline-primary" data-toggle="modal" title="Assign Subject">
                          <span class="fa fa-plus"></span> Assign Subject
                      </a>                                                      
                  </div>
                  <br><br><br>
                  <div class="text-center"  id="preloader" style="display: none;"><img  src="../assets/img/giphy (1).gif" style="width: 50px;"></div>
                  <div id="as_results"></div>                
              </div>              
            </div>
            <div class="col-sm-5">
                <div class="card">
                  <div class="container-fluid">
                    <br>
                       ...
                       <div id="scheduled_faculty_and_subject"></div>
                    </div>
                  </div>
                </div>               
            </div>
...
<?php  include 'modals/assign_subject_modal.php' ?>  
<?php  include 'modals/assign_schedule_modal.php' ?>  
<?php include 'html_part/footer.php'; ?>
<script src="../assets/js/custom_class_schedule.js"></script> 