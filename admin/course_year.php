        ...
        <div class="container-fluid">
           <nav aria-labelled="breadcrumb">
             <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active" aria-current="page"><a href="#">Course Year</a></li>
             </ol>
           </nav>
           ...
           <div class="table-responsive">
                <div class="pull-right">  
                    <a href="#add_course_year" class="btn btn-sm btn-outline-primary" data-toggle="modal" title="Print Document">
                        <span class="fa fa-plus"></span> Add Course Year and Section
                    </a>                                                      
                </div>
                <br><br><br>
                <div class="text-center"  id="preloader" style="display: none;"><img  src="../assets/img/giphy (1).gif" style="width: 50px;"></div>
                <div id="result_course_year"></div>
           </div>
        </div>        
    </div>
    <!-- /main Panel -->
</div>    
<?php  include 'modals/course_year_modal.php' ?> 
<?php include 'html_part/footer.php'; ?>
<script src="../assets/js/custom_course_year.js"></script>  