        ...
        <div class="container-fluid">
           <nav aria-labelled="breadcrumb">
             <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active" aria-current="page"><a href="#">Semester</a></li>
             </ol>
           </nav> 
          <div class="box-container">
           ...
           <div class="table-responsive">
                <div class="pull-right">
                    <a href="#change_semester" class="btn btn-sm btn-outline-primary" data-toggle="modal" title="Print Document">
                        <span class="fa fa-refresh"></span> Change Semester
                    </a>   
                    <a href="#addsemester" class="btn btn-sm btn-outline-primary" data-toggle="modal" title="Print Document">
                        <span class="fa fa-calendar"></span> Add New Semester
                    </a>                                                      
                </div>
                <br><br><br>
                <div class="text-center"  id="preloader" style="display: none;"><img  src="../assets/img/giphy (1).gif" style="width: 50px;"></div>
                <div id="result_semester"></div>
           </div>
        </div>        
    </div>
    <!-- /main Panel -->
</div>    
<?php  include 'modals/semester_modal.php' ?>
<?php include 'html_part/footer.php'; ?>
<script src="../assets/js/semester_custom.js"></script>  