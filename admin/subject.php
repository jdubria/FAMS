        ...
        <div class="container-fluid">
          <div class="box-container">
           ...
           <div class="table-responsive">
                <div class="pull-right">
                    <a href="#addsubject" class="btn btn-sm btn-outline-primary" data-toggle="modal" title="Add Subject">
                        <span class="fa fa-plus"></span> Add Subject
                    </a>                                                      
                </div>
                <br><br><br>
...
<?php include 'modals/subject_modal.php'; ?> 
<?php include 'html_part/footer.php'; ?>
<script src="../assets/js/subject_customized.js"></script> 