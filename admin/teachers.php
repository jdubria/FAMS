        ...
        <div class="container-fluid">
          <div class="box-container">
           ...
           <div class="table-responsive">
                <div class="pull-right">
                    <a href="#addTeacher" class="btn btn-sm btn-outline-primary" data-toggle="modal" title="Print Document">
                        <span class="fa fa-user-plus"></span> Add Teacher
                    </a>                                                      
                </div>
                <br><br><br>
...
<?php include 'modals/teacher_modal.php' ?>  
